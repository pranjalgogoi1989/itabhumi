...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $stmt= $pdo->prepare('INSERT INTO land_allotment(unique_id,passbook_no,allotment_no,allotment_date,allotee_name,mobile_no,land_type,total_area,plot_location,dag_no,sheet_no,paid_upto,lease_period) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?);');
        $stmt->execute([
            $unique_id,
            $passbook_no,
            $allotment_no,
...
<fieldset>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <input type="text" class="form-control" name="plot_location">
        </div>
    </div>
    <div class="row">
        <div class="col-sm-4">
